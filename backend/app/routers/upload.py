...
def get_stored_document(batch_id: str, doc_id: str) -> FileResponse:
...
def bundle_stored_batch(batch_id: str) -> Response:
...
async def bundle_uploads(files: list[UploadFile] = File(...)) -> Response:
